    ...
    while (rank_str != 0)
    {
        ...
        while (file < 8)
        {
            ...
            else
            {
                ...
                if (curr_char == 112)
                {
                    board.Wpawn = board.Wpawn | (unsigned long long)1 << curr_square;
                }
                // 80 -> 'P'
                else if (curr_char == 80)
                {
                    board.Bpawn = board.Bpawn | (unsigned long long)1 << curr_square;
                }
                // 110 -> 'n'
                else if (curr_char == 110)
                {
                    board.Wknight = board.Wknight | (unsigned long long)1 << curr_square;
                }
                // 78 -> 'N'
                else if (curr_char == 78)
                {
                    board.Bknight = board.Bknight | (unsigned long long)1 << curr_square;                
                }
                // 98 -> 'b'
                else if (curr_char == 98)
                {
                     board.Wbishop = board.Wbishop | (unsigned long long)1 << curr_square;
                }
                // 66 -> 'B'
                else if (curr_char == 66)
                {
                     board.Bbishop = board.Bbishop | (unsigned long long)1 << curr_square;
                }
                // 114 -> 'r'
                else if (curr_char == 114)
                {
                     board.Wrook = board.Wrook | (unsigned long long)1 << curr_square;
                }
                // 82 -> 'R'
                else if (curr_char == 82)
                {
                     board.Brook = board.Brook | (unsigned long long)1 << curr_square;
                }
                // 113 -> 'q'
                else if (curr_char == 113)
                {
                     board.Wqueen = board.Wqueen | (unsigned long long)1 << curr_square;
                }
                // 81 -> 'Q'
                else if (curr_char == 81)
                {
                     board.Bqueen = board.Bqueen | (unsigned long long)1 << curr_square;
                }
                // 107 -> 'k'
                else if (curr_char == 107)
                {
                     board.Wking = board.Wking | (unsigned long long)1 << curr_square;
                }
                // 75 -> 'K'
                else if (curr_char == 75)
                {
                     board.Bking = board.Bking | (unsigned long long)1 << curr_square;
                }
                file_index++;
                file++;
            }
